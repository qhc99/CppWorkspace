...
#ifndef LEARNCPP_SMARTPTRANDITERDEMO_CPP
#define LEARNCPP_SMARTPTRANDITERDEMO_CPP
namespace org::nathan::smartPtrAndIterDemo {
    ...
    public:
        ...
        std::shared_ptr <DoubleLinedNode> right;
    ...
    class DoubleLinkedList {
        // TODO abuse shared ptr, performance issue
    ...
    [[maybe_unused]] void destructionAndForRangeDemo() {
        ...
        std::cout << "destruction end" << std::endl;
        {
...
#endif //LEARNCPP_SMARTPTRANDITERDEMO_CPP
