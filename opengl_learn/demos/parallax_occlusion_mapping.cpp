...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture((std::filesystem::current_path() / "bricks2.jpg").string().c_str());
    unsigned int normalMap = loadTexture((std::filesystem::current_path() / "bricks2_normal.jpg").string().c_str());
    unsigned int heightMap = loadTexture((std::filesystem::current_path() / "bricks2_disp.jpg").string().c_str());
